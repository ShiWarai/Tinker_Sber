...
extern _LINK_CMD o_cmd;
#define SEND_BUF_SIZE1 64+32	//�������ݳ���,��õ���sizeof(TEXT_TO_SEND)+2��������.250	//�������ݳ���,��õ���sizeof(TEXT_TO_SEND)+2��������.
...
#define SEND_BUF_SIZE3 100	//�������ݳ���,��õ���sizeof(TEXT_TO_SEND)+2��������.
...
#define SEND_BUF_SIZE6 100	//�������ݳ���,��õ���sizeof(TEXT_TO_SEND)+2��������.
extern u8 SendBuff6[SEND_BUF_SIZE6];	//�������ݻ�����
