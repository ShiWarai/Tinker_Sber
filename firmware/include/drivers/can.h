...
/* ---- feedback ---- */
uint8_t            can1_get_feedback(uint8_t motor_id,
                                     can_motor_feedback_t *out);
uint8_t            can1_get_last_feedback(can_motor_feedback_t *out);
uint8_t            can1_is_motor_connected(uint8_t motor_id,
                                            uint32_t timeout_ms);
...
/* ---- volatile debug/diagnostic variables (watch in debugger) ---- */
