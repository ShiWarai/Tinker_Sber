...
char data_can_mit_send(motor_measure_t *ptr)
{
	...
	float t_ff = fminf_mit(fmaxf_mit(T_MIN_CAN_MIT[id], LIMIT(set_t, -ptr->max_t, ptr->max_t)), T_MAX_CAN_MIT[id]);
...
static void mit_motors_init(void)
{
	...
	motor_chassis[5].motor.type = DM_6006;
	motor_chassis[5].param.q_flag = 0;
	motor_chassis[6].motor.type = DM_8006;
	motor_chassis[6].param.q_flag = 1;
	motor_chassis[7].motor.type = DM_8006;
	motor_chassis[7].param.q_flag = 0;
	motor_chassis[8].motor.type = DM_8006;
	motor_chassis[8].param.q_flag = 1;
	motor_chassis[9].motor.type = DM_6006;
	motor_chassis[9].param.q_flag = 0;
