...
typedef struct
{
	...
	//
	float att_trig[4], att_ctrl[4], att_rate_trig[3], att_rate_ctrl[3], att[3], att_rate[3], att_vm_b[3], att_vm[3],
	    att_rate_vm[3], att_vmo[3], acc[4];
...
typedef struct
{
	...
	int key_ud, key_lr, key_x, key_y, key_a, key_b, key_ll, key_rr, key_st, key_back, key_ud_reg, key_lr_reg, key_x_reg,
	    key_y_reg, key_a_reg, key_b_reg, key_ll_reg, key_rr_reg, key_st_reg, key_back_reg;
	float curve[20];
