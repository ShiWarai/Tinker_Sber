...
Здесь реализовано многопоточное C++ приложение для управления роботом, обеспечивающее:

- **SPI коммуникацию** с микроконтроллером STM32 (с частотой 20 МГц)
- **Управление 10 двигателями** с использованием PID
...
│   ├── serial.cpp      # Последовательная коммуникация
...
- **Максимальная длина пакета:** 160 байт
